...
With this project, you can build up in minutes a fully working k8s cluster (single control/HA) with as many worker nodes as you want. 
...
- **schedulable control** if you want to schedule on your control nodes or leave the taint.
